...
var Tixia = function(){
	...
	return {
		init:function(){
			handleSelectPicker();
			/* handleTheme déplacé dans load() pour afficher le loader jusqu'au chargement complet */
			handleMetisMenu();
			handleAllChecked();
			handleNavigation();
			handleCurrentActive();
		...
		load:function(){
			handleSelectPicker();
			/* handleTheme géré par le script du loader dans le layout (durée min + logo) */
		},
