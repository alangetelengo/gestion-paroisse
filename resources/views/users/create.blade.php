        ...
        <div class="card border-0 shadow-sm create-help-panel">
            <div class="card-body p-4">
                ...
                <ul class="list-unstyled small mb-0">
                    <li class="mb-2">1. Renseigner <strong>nom</strong>, <strong>email</strong> et <strong>mot de passe</strong>.</li>
                    <li class="mb-0">2. Choisir le <strong>rôle</strong> et la paroisse si applicable.</li>
                </ul>
            </div>
        </div>
    </div>
